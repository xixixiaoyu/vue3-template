...
const colorClasses = computed(() => {
  ...
  switch (props.notification.type) {
    ...
    default:
      return `${baseClasses} bg-gray-50 dark:bg-gray-900/20 border-gray-400 text-gray-800 dark:text-gray-200`
  }
})
    ...
    <div class="flex">
      ...
      <div class="ml-auto pl-3">
        <div class="-mx-1.5 -my-1.5">
          <button
            type="button"
            :class="`inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 ${
